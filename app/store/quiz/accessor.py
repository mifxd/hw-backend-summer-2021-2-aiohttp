...
class QuizAccessor(BaseAccessor):
    ...
    async def create_question(
        ...
        question = Question(id=self.app.database.next_question_id, title=title, answers=answers, theme_id=theme_id)
    ...
    async def list_questions(
        ...
        if theme_id:
            questions = [q for q in questions if q.theme_id == theme_id]
